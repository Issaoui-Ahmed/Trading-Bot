...
from feature_engineering.xgb_trend_features import engineer_features
from target_engineering.xgb_trend_targets import engineer_targets

class XGBTrend:
    def __init__(self):
        self.model_name = 'xgb_trend'
        self.features = ['MACD', 'MACD_Signal', 'ROC_10', 'RSI_14', 'SMA_20']
        self.target = 'Target_Trend'
        self.model = xgb.XGBClassifier(objective='binary:logistic', n_estimators=100, eval_metric='logloss')
